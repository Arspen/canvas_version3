...
/*    test({ lastPlacement }) {
  ...
  */
  ...
  module.exports = [{
      id: 'repeat-object-10',
      question: "I've noticed you often use the word: '{{word}}'. What are you making?",
      dynamic: true,
      test: ({
        wordCounts
      }) => {
    ...
    },
    {
      ...
      question: "I've noticed your language often leans towards '{{category}}'. What is your plan?",
      dynamic: true,
      test: ({
        total,
        categoryCounts
